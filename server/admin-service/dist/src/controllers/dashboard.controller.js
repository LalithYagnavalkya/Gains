...
exports.fetchDashboardTransactionsData = exports.dashboardCustomerStats = void 0;
//models
const transaction_model_1 = __importDefault(require("../models/transaction.model"));
const membership_model_1 = __importDefault(require("../models/membership.model"));
const dashboardCustomerStats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const memberships = yield membership_model_1.default.find(membershipFilter).lean();
...
exports.dashboardCustomerStats = dashboardCustomerStats;
const fetchDashboardTransactionsData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let graphData = [
        {
            month: 0,
            name: "Jan",
    ...
    try {
        ...
        const transactions = yield transaction_model_1.default.find(transactionFilter).populate('userId', 'username email').sort({ createdAt: -1 }).lean();
        const totalAmount = transactions.reduce((acc, tran) => {
            var _a, _b, _c;
            if (((_a = tran.createdAt) === null || _a === void 0 ? void 0 : _a.getMonth()) === currentDate.getMonth() && ((_b = tran.createdAt) === null || _b === void 0 ? void 0 : _b.getDate()) === currentDate.getDate()) {
                acc.totalCurrentDayRevenue += +tran.paymentAmount;
            }
            if (((_c = tran.createdAt) === null || _c === void 0 ? void 0 : _c.getMonth()) === currentDate.getMonth()) {
                acc.totalCurrentMonthRevenue += tran.paymentAmount;
                acc.currentMonthCount += 1;
            }
            let foundMonthData = graphData.find(item => { var _a; return item.month === ((_a = tran.createdAt) === null || _a === void 0 ? void 0 : _a.getMonth()); });
            if (foundMonthData) {
        ...
        res.status(200).json({
            error: false,
            totalDayRevenue: totalAmount === null || totalAmount === void 0 ? void 0 : totalAmount.totalCurrentDayRevenue,
...
exports.fetchDashboardTransactionsData = fetchDashboardTransactionsData;
